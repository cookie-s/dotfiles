...
beautiful.init("/home/cookies/.config/awesome/theme.lua")
...
-- end):add()
-- 
-- keybinding({ modkey, "Control" }, "l", function ()
--     awful.client.moveresize(20, 0, 0, 0)
-- end):add()
-- 
-- keybinding({ modkey, "Control" }, "k", function ()
--     awful.client.moveresize(0, -20, 0, 0)
-- end):add()
-- 
-- keybinding({ modkey, "Control" }, "j", function ()
--     awful.client.moveresize(0, 20, 0, 0)
-- end):add()
-- 
-- -- Resize window with arrow keys
-- keybinding({ modkey, "Control", "Shift" }, "h", function ()
--     awful.client.moveresize(0, 0, -20, 0)
-- end):add()
-- 
-- keybinding({ modkey, "Control", "Shift" }, "l", function ()
--     awful.client.moveresize(0, 0, 20, 0)
-- end):add()
-- 
-- keybinding({ modkey, "Control", "Shift" }, "k", function ()
--     awful.client.moveresize(0, 0, 0, -20)
-- end):add()
-- 
-- keybinding({ modkey, "Control", "Shift" }, "j", function ()
--     awful.client.moveresize(0, 0, 0, 20)
-- end):add()
--                                                                                                                                                                                                                                                                 ----------------------------------------
awful.key({ modkey ,"Shift"}, "w", function () awful.util.spawn_with_shell("mikutter >>/tmp/luakit.log") end)
)
